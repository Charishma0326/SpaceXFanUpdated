...
class UpcomingLaunches: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        reuse.urlStr = "https://api.spacexdata.com/v4/launches/upcoming"
        
        getUpComingRocketsListService()
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if UserDefaults.standard .value(forKey: "button") as! String == "unselected" {
            
            cell.likeBtn.setImage(UIImage (systemName: "bookmark"), for: .normal)
        }
        
        else {
            
            cell.likeBtn.setImage(UIImage (systemName: "bookmark.fill"), for: .normal)
...
//            UserDefaults.standard .setValue("unselected", forKey: "button")
        ...
        
        {
            ...
            UserDefaults.standard .setValue("selected", forKey: "button")
            setDocument ()
            addDocument()
    ...
    func getUpComingRocketsListService() {
